...
rather than `examples/example.rb` (that file is the step 10 MUD demo,
inherited unchanged in spirit — it exercises `mcp_servers:` wiring the same
way step 10's does, but doesn't touch the TUI).
