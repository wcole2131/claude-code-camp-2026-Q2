...
# ShellTools registers command-execution tools against a Boukensha::Registry.
#
# This used to live inside the Boukensha framework itself, as
# Boukensha::Tools::Shell -- it moved here because the framework no longer
# ships any domain tool implementations (see
# docs/plans/mud_manager/mcp_mud_plan.md). This is server-side code now,
# owned by shell_mcp, not agent-side code.
#
# Tools registered:
