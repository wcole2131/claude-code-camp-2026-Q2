...
class Logger:
    ...
    def prompt(self, *, messages: list[Message], tools: dict[str, Tool], context_window: int) -> None:
        self._write_log(
            {
                "phase": "prompt",
    ...
    def response(self, *, text: str, usage: Any = None, stop_reason: str | None = None) -> None:
